...
# "make solver_tests" will run the tests on solver
solver_tests : solver
	./run_solver_tests.sh testfiles/input1 testfiles/input1.out 
	./run_solver_tests.sh testfiles/input2 testfiles/input2.out 
	./run_solver_tests.sh testfiles/input3 testfiles/input3.out 
	./run_solver_tests.sh testfiles/input4 testfiles/input4.out 
	./run_solver_tests.sh testfiles/input5 testfiles/input5.out 
	./run_solver_tests.sh testfiles/input6 testfiles/input6.out 
	./run_solver_tests.sh testfiles/input8 testfiles/input8.out 
